...
public class PruebasTryCatch {
	...
	public static void main(String[] args) {
		...
		* Las excepciones de tipo Error son arrojadas
		 ...
		 * 
		 * try: Bloque de código que prueba los erroes mientras
		 *  se ejecuta.
		...
		/**Lo siguiente va a marcar error por qeu se intenta acceder
		al indice 5, y esto no existe nen el arreglo de 4 elementos.
		...
		*/
		...
		System.out.println("Realizamos la lectura de un archivo");
		File file = new File("miarchivo.txt");
		//El IDE nos ayuda a procesar la excepcion
		// se puede hacer en la firma del metodo
		// con throws throws FileNotFoundException 
		try {
