...
public class persona {
	...
	public Persona(){
	this.chsmPublic = " Dafne le gusta cristian nodal";
	this.chsmProtected = "Le gustó su nuevo album";
	this.chsmDefault = "Me comí un pan de chocolate";
	this.chsmPrivate = "Me gusta la nieve raspada";
	}
