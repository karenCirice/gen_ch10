...
test ("Debería sumar dos número negativos", () => {
...
test ("Debería restar dos número negativos", () => {
...
test ("Debería obtener el área de un rectangulo", () => {
    const operacion = area.areaRectangulo  (10, 20); //Paso parámetros a la función suma
