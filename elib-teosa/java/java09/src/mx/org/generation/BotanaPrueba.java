...
public class BotanaPrueba {
	...
	public static void main(String[] args) {
		// Aquí es probamos las botanas ^^
				...
				/*
				 * Botana totis = new Botana("Totis fuego", 3000, false, 1); Botana caviar = new
				 * Botana("Caviar", 5000, true, 2); Botana papas = new Botana ("Papas chips",
				 * 8000, false, 3); Botana ceviche = new Botana ("Ceviche", 10000, true, 4);
