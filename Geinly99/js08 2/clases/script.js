...
class Persona{
    ...
    constructor(nombre,apellido,edad,poder,banda){
        ...
        this._apellido = apellido; //aquí podríamos no haber declarado las funciones por algun motivo, pero mejo hay que declararlas
        this._edad = edad; 
        this._poder = poder;
        this._banda = banda;
...
console.log(personaBig);
//el gato protege la función y solo se puede utilizar dentro de la clase, va antes de declarar la función y protege que no tengan acceso a la función fuera de la clase
//puedes no declarar los atributos al inicio de la clase pero al poner this.atributo, ya lo declaraste y ya lo puedes usar