...
public class Persona {
	...
	public Persona() {
		this.chsmPublic = "Karla está embarazada";
		this.chsmProtected = "A Sergio le gusta el café";
		this.chsmDefault = "Sergio rompió un plato al lavarlo";
		this.chsmPrivate = "A Sergio le gusta una canción de Selena G";
	}
