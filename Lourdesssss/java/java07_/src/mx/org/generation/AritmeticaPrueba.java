...
public class AritmeticaPrueba {
	...
	public static void main(String[] args) {
		...
		System.out.println("Resultado reurn: " + resultado);
		...
		System.out.println("Introduce tu edad: ");
	     ...
	     //char apellido = sc.next().charAt(0);
	     char apellido = apellidoString.charAt(0);
	     apellidoString.length();
