...
public class Main {
	...
	public static void main(String[] args) {
		...
		if(condicion) {
			...
			bandera =3;
			System.out.println("La cpndición es verdadera");
		}
		//comando rápido syso + ctrl + space
		//si If solo tiene una instrucción no es necesario las llaves 
		...
		*/
		...
		System.out.println("Estación de año: " + estacion);
