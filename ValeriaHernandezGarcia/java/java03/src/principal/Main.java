...
public class Main {
	public static void main(String[] args){
		...
		short s = 10000;
		//Dfinimos una varibale de tipo int, representación decimal
		int intVal = 26;
		...
		*/
		//Verificamos el máximo valor de un tip long
		...
		*/
		...
		//Con parentesís primero hace la suma y luego la concatenación
