...
public class AritmeticaPrueba {
	...
	public static void main(String[] args) {
		...
		operacion.sumar();
			...
			Scanner sc = new Scanner(System.in); //Scanner es para imprimir en consola
			System.out.println("Introduce tu edad :");
		     int i = sc.nextInt(); //se pone Int al final
		     
		     System.out.println("Introduce tu nombre :");
		     String name = sc.next(); //si es String solo se pone next
